...
{
    public partial class ShenAiPage : ComponentBase
    {
        [Inject]
        ...
        //public async Task StartShenAI()
        //{
        //    try 
        //    {
        //        isInitialized = await jsRun.InvokeAsync<bool>("initializeShenAI", ApiKey, userId);
        //    }
        //    catch(Exception ex)
        //    {
        //        errorMsg = ex.Message;
        ...
        //    try
        //    {
        //        await jsRun.InvokeVoidAsync("initializeShenAI", ApiKey, userId);
        ...
        //    }
        //}
        private void ShowRiskForm()
        {
            showRiskForm = true;
        }

        private async Task ComputeRisks()
        {
            try
            {
                await jsRun.InvokeVoidAsync("computeRisks", riskForm);
            }
            catch (JSException jsEx)
            {
                errorMsg = $"Failed to compute risks: {jsEx.Message}";
            }
        }
